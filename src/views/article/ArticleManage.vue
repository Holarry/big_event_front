    ...
    <el-card class="page-container">
        <template #header>
            <div class="header">
                <span>文章管理</span>
                <div class="extra">
                    <el-button type="primary" @click="showAddDrawer()">发布文章</el-button>
                </div>
            </div>
        </template>
        <!-- 搜索表单 -->
            ...
            <el-form :model="articleModel" label-width="100px">
                ...
                <el-form-item label="文章封面">
                    ...
                    <!-- 
                     ...
                     -->
                    <el-upload class="avatar-uploader" :auto-upload="true" :show-file-list="false" action="/api/file/upload"
                ...
                <el-form-item>
                    <el-button type="primary"
                        @click="title == '发布文章' ? addArticle('已发布') : updateArticle('已发布')">发布</el-button>
                    <el-button type="info" @click="title == '发布文章' ? addArticle('草稿') : updateArticle('草稿')">草稿</el-button>
                </el-form-item>
            </el-form>
        </el-drawer>
    </el-card>
